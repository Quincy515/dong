...
import 'cai_gou_ji_hua_ming_xi_biao_model.dart';
export 'cai_gou_ji_hua_ming_xi_biao_model.dart';

class CaiGouJiHuaMingXiBiaoWidget extends StatefulWidget {
  const CaiGouJiHuaMingXiBiaoWidget({Key? key}) : super(key: key);

  @override
  _CaiGouJiHuaMingXiBiaoWidgetState createState() =>
      _CaiGouJiHuaMingXiBiaoWidgetState();
}

class _CaiGouJiHuaMingXiBiaoWidgetState
    extends State<CaiGouJiHuaMingXiBiaoWidget> {
  late CaiGouJiHuaMingXiBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CaiGouJiHuaMingXiBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.caiGouJiHuaMingXiItemModel1,
                              updateCallback: () => setState(() {}),
                              child: CaiGouJiHuaMingXiItemWidget(
                                item: null,
                              ),
                            ),
                                  ...
                                  builder: (context) {
                                    ...
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return CaiGouJiHuaMingXiItemWidget(
                                          key: Key(
                                              'Key25n_${listIndex}_of_${list.length}'),
                                          item: listItem,
                                        );
                                      }),
                                    );
