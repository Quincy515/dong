...
import 'she_bei_zu_lin_biao_model.dart';
export 'she_bei_zu_lin_biao_model.dart';

class SheBeiZuLinBiaoWidget extends StatefulWidget {
  const SheBeiZuLinBiaoWidget({Key? key}) : super(key: key);

  @override
  _SheBeiZuLinBiaoWidgetState createState() => _SheBeiZuLinBiaoWidgetState();
}

class _SheBeiZuLinBiaoWidgetState extends State<SheBeiZuLinBiaoWidget> {
  late SheBeiZuLinBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SheBeiZuLinBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.sheBeiZuLinItemModel1,
                              updateCallback: () => setState(() {}),
                              child: SheBeiZuLinItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "group": "",
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetSheBeiZuLinBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = SheBeiZuLinBiaoGroup
                                            .getSheBeiZuLinBiaoListCall
                                            .list(
                                              columnGetSheBeiZuLinBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return wrapWithModel(
                                          model: _model.sheBeiZuLinItemModels2
                                              .getModel(
                                            listIndex.toString(),
                                            listIndex,
                                          ),
