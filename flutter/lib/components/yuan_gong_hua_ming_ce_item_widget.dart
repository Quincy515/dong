        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  setState(() => _model.unfold = !_model.unfold);
                },
                child: StyledDivider(
                  thickness: 1.0,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.laoDongHeTongKaiShiRiQiController,
                                obscureText: false,
                                decoration: InputDecoration(
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodyText2,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                onChanged: (val) {
                                  setState(() {
                                    if (verifyCardId(_model
                                        .shenFenZhengHaoMaController.text)) {
                                      _model.nianLingController.text =
                                          getAgeFromCardId(_model
                                                  .shenFenZhengHaoMaController
                                                  .text)
                                              .toString();
                                      _model.xingBieController.text =
                                          getSexFromCardId(_model
                                                  .shenFenZhengHaoMaController
                                                  .text)
                                              .toString();
                                      _model.chuShengRiQiController.text =
                                          getBirthday(_model
                                              .shenFenZhengHaoMaController
                                              .text);
                                    }
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.heTongYueDingGongZiController,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintStyle:
                                        FlutterFlowTheme.of(context).bodyText2,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.geRenSheBaoZhangHaoController,
                                obscureText: false,
                                decoration: InputDecoration(
                                  hintStyle:
                                      FlutterFlowTheme.of(context).bodyText2,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                validator: _model
                                    .geRenSheBaoMiMaControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: _model
                                      .menJinBianHaoControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
