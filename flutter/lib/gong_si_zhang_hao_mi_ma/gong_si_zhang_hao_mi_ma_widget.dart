...
import 'gong_si_zhang_hao_mi_ma_model.dart';
export 'gong_si_zhang_hao_mi_ma_model.dart';

class GongSiZhangHaoMiMaWidget extends StatefulWidget {
  const GongSiZhangHaoMiMaWidget({Key? key}) : super(key: key);

  @override
  _GongSiZhangHaoMiMaWidgetState createState() =>
      _GongSiZhangHaoMiMaWidgetState();
}

class _GongSiZhangHaoMiMaWidgetState extends State<GongSiZhangHaoMiMaWidget> {
  late GongSiZhangHaoMiMaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GongSiZhangHaoMiMaModel());
  }
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetGongSiZhangHaoMiMaListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = BanGongShiGroup
                                            .getGongSiZhangHaoMiMaListCall
                                            .list(
                                              columnGetGongSiZhangHaoMiMaListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return GongSiZhangHaoMiMaItemWidget(
                                          key: Key(
                                              'Keyiu6_${listIndex}_of_${list.length}'),
                                          item: listItem,
                                        );
                                      }),
                                    );
