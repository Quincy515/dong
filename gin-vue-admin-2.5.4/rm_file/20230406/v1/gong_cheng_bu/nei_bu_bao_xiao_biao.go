...
var neiBuBaoXiaoBiaoService = service.ServiceGroupApp.Gong_cheng_buServiceGroup.NeiBuBaoXiaoBiaoService
...
// @Param data body gong_cheng_bu.NeiBuBaoXiaoBiao true "创建NeiBuBaoXiaoBiao"
...
func (neiBuBaoXiaoBiaoApi *NeiBuBaoXiaoBiaoApi) CreateNeiBuBaoXiaoBiao(c *gin.Context) {
	var neiBuBaoXiaoBiao gong_cheng_bu.NeiBuBaoXiaoBiao
...
// @accept application/json
// @Produce application/json
// @Param data body gong_cheng_bu.NeiBuBaoXiaoBiao true "删除NeiBuBaoXiaoBiao"
...
func (neiBuBaoXiaoBiaoApi *NeiBuBaoXiaoBiaoApi) DeleteNeiBuBaoXiaoBiaoByIds(c *gin.Context) {
	...
	if err := neiBuBaoXiaoBiaoService.DeleteNeiBuBaoXiaoBiaoByIds(IDS,deletedBy); err != nil {
...
// @accept application/json
// @Produce application/json
// @Param data body gong_cheng_bu.NeiBuBaoXiaoBiao true "更新NeiBuBaoXiaoBiao"
...
// @accept application/json
// @Produce application/json
// @Param data query gong_cheng_bu.NeiBuBaoXiaoBiao true "用id查询NeiBuBaoXiaoBiao"
...
// @accept application/json
// @Produce application/json
// @Param data query gong_cheng_buReq.NeiBuBaoXiaoBiaoSearch true "分页获取NeiBuBaoXiaoBiao列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
...
func (neiBuBaoXiaoBiaoApi *NeiBuBaoXiaoBiaoApi) GetNeiBuBaoXiaoBiaoList(c *gin.Context) {
	var pageInfo gong_cheng_buReq.NeiBuBaoXiaoBiaoSearch
