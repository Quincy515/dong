...
class _GongSiZhangHaoMiMaItemWidgetState
  ...
  void initState() {
    ...
    _model.zhaoHuiMiMaJiLuController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.zhaoHuiMiMaJiLu''',
    ).toString().toString());
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.zhaoHuiMiMaJiLuController,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    hintStyle:
                                        FlutterFlowTheme.of(context).bodyText2,
                                  ...
                                  validator: _model
                                      .zhaoHuiMiMaJiLuControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                                  ...
                                  itemJson: jsonDecode('''
{
  ...
  "jieShuYouXiaoQi": "${dateTimeRfc3339(dateTime: _model.datePicked2)}",
  "kaiShiYouXiaoQi": "${dateTimeRfc3339(dateTime: _model.datePicked1)}",
  ...
  "zhaoHuiMiMaJiLu": "${_model.zhaoHuiMiMaJiLuController.text}"
}
  '''),
                                );
                                ScaffoldMessenger.of(context).showSnackBar(
