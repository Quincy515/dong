...
import 'chu_ru_ku_ming_xi_biao_model.dart';
export 'chu_ru_ku_ming_xi_biao_model.dart';

class ChuRuKuMingXiBiaoWidget extends StatefulWidget {
  const ChuRuKuMingXiBiaoWidget({Key? key}) : super(key: key);

  @override
  _ChuRuKuMingXiBiaoWidgetState createState() =>
      _ChuRuKuMingXiBiaoWidgetState();
}

class _ChuRuKuMingXiBiaoWidgetState extends State<ChuRuKuMingXiBiaoWidget> {
  late ChuRuKuMingXiBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChuRuKuMingXiBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue!)
                            wrapWithModel(
                              model: _model.chuRuKuMingXiitemModel1,
                              updateCallback: () => setState(() {}),
                              child: ChuRuKuMingXiitemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "caiGouLiang": 0,
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetChuRuKuMingXiBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = ChuRuKuMingXiBiaoGroup
                                            .getChuRuKuMingXiBiaoListCall
                                            .list(
                                              columnGetChuRuKuMingXiBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return wrapWithModel(
                                          model: _model.chuRuKuMingXiitemModels2
                                              .getModel(
                                            listIndex.toString(),
                                            listIndex,
                                          ),
