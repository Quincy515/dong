...
import 'gong_ying_shang_item_model.dart';
export 'gong_ying_shang_item_model.dart';

class GongYingShangItemWidget extends StatefulWidget {
  const GongYingShangItemWidget({
    Key? key,
    this.item,
  }) : super(key: key);
  ...
  @override
  _GongYingShangItemWidgetState createState() =>
      _GongYingShangItemWidgetState();
}

class _GongYingShangItemWidgetState extends State<GongYingShangItemWidget> {
  late GongYingShangItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GongYingShangItemModel());
    ...
    _model.faRenShenFenZhengController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.faRenShenFenZheng''',
    ).toString().toString());
    ...
    _model.gongSiDiZhiController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.gongSiDiZhi''',
    ).toString().toString());
    _model.lianXiRenlianXiRenController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.lianXiRen''',
    ).toString().toString());
    _model.lianXiRenShouJiController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.lianXiRenShouJi''',
    ).toString().toString());
    _model.faPiaoTaiTouController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.faPiaoTaiTou''',
    ).toString().toString());
                      ...
                      child: Container(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final gongYingShangMingChengGetFenBaoShangBiaoListResponse =
                                snapshot.data!;
                            return Container(); /*FlutterFlowDropDownNew<int>(
                              controller:
                                  _model.gongYingShangMingChengController ??=
                                      FormFieldController<int>(
                                _model.gongYingShangMingChengValue ??=
                                    getJsonField(
                                  widget.item,
                                  r'''$.gongYingShangMingCheng''',
                                ),
                              ),
                              options: (FenBaoShangBiaoGroup
                                      .getFenBaoShangBiaoListCall
                                      .value(
                                gongYingShangMingChengGetFenBaoShangBiaoListResponse
                                    .jsonBody,
                              ) as List)
                                  .map<int>((s) => int.parse(s.toString()))
                                  .toList(),
                              optionLabels: (FenBaoShangBiaoGroup
                                      .getFenBaoShangBiaoListCall
                                      .label(
                                gongYingShangMingChengGetFenBaoShangBiaoListResponse
                                    .jsonBody,
                              ...
                              onChanged: (val) => setState(() =>
                                  _model.gongYingShangMingChengValue = val),
                              width: 180.0,
                              height: 50.0,
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            controller: _model.faRenShenFenZhengController,
                            obscureText: false,
                            decoration: InputDecoration(
                              hintStyle: FlutterFlowTheme.of(context).bodyText1,
                              enabledBorder: UnderlineInputBorder(
                            ...
                            validator: _model
                                .faRenShenFenZhengControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            controller: _model.gongSiDiZhiController,
                            obscureText: false,
                            decoration: InputDecoration(
                              hintStyle: FlutterFlowTheme.of(context).bodyText1,
                              enabledBorder: UnderlineInputBorder(
                            ...
                            validator: _model.gongSiDiZhiControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.lianXiRenlianXiRenController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText1,
                            enabledBorder: UnderlineInputBorder(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.lianXiRenShouJiController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText1,
                            enabledBorder: UnderlineInputBorder(
                          ...
                          maxLines: null,
                          validator: _model.lianXiRenShouJiControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.faPiaoTaiTouController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText1,
                            enabledBorder: UnderlineInputBorder(
                          ...
                          maxLines: null,
                          validator: _model.faPiaoTaiTouControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                            ...
                            builder: (context, snapshot) {
                              ...
                              return FlutterFlowDropDownNew<int>(
                                ...
                                options: (FileGroup.findSysDictionaryCall.value(
                                  faPiaoLeiXingFindSysDictionaryResponse
                                      .jsonBody,
                                ) as List)
                                    .map<int>((s) => int.parse(s.toString()))
                                    .toList(),
                    ...
                    InkWell(
                      onLongPress: () async {
                        ...
                        if (confirmDialogResponse) {
                          _model.deleteRes = await GongYingShangBiaoGroup
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.updateRes = await GongYingShangBiaoGroup
                            ...
                            itemJson: jsonDecode('''
{
  ...
  "faPiaoTaiTou": "${_model.faPiaoTaiTouController.text}",
  "faRenShenFenZheng": "${_model.faRenShenFenZhengController.text}",
  "gongSiDiZhi": "${_model.gongSiDiZhiController.text}",
  "gongYingShangMingCheng": ${_model.gongYingShangMingChengValue},
  "group": "${_model.groupController.text}",
  "kaiHuHang": "${_model.kaiHuHangController.text}",
  "lianXiRen": "${_model.lianXiRenlianXiRenController.text}",
  "lianXiRenShouJi": "${_model.lianXiRenShouJiController.text}",
  "sheHuiXinYongDaiMa": "${_model.sheHuiXinYongDaiMaController.text}",
  "tianJiaRen": ${_model.tianJiaRenValue},
  "tianJiaRiQi": "${dateTimeRfc3339(dateTime: _model.datePicked)}",
