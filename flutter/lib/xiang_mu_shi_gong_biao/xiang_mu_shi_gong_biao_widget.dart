...
import 'xiang_mu_shi_gong_biao_model.dart';
export 'xiang_mu_shi_gong_biao_model.dart';

class XiangMuShiGongBiaoWidget extends StatefulWidget {
  const XiangMuShiGongBiaoWidget({Key? key}) : super(key: key);

  @override
  _XiangMuShiGongBiaoWidgetState createState() =>
      _XiangMuShiGongBiaoWidgetState();
}

class _XiangMuShiGongBiaoWidgetState extends State<XiangMuShiGongBiaoWidget> {
  late XiangMuShiGongBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XiangMuShiGongBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.xiangMuShiGongItemModel1,
                              updateCallback: () => setState(() {}),
                              child: XiangMuShiGongItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "gongZuoMingCheng": "",
  "group": "",
  "jiHuaKaiShiRiQi": "${DateTime.now()}",
  "jiHuaTianShu": 0,
  "jiHuaWanChengRiQi": "${DateTime.now()}",
  "shunXu": 0,
  "wanChengBi": 0,
  "xiangMuId": 0,
  ...
  '''),
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              future: XiangMuShiGongBiaoGroup
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetXiangMuShiGongBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = XiangMuShiGongBiaoGroup
                                            .getXiangMuShiGongBiaoListCall
                                            .list(
                                              columnGetXiangMuShiGongBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
