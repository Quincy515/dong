                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.dictionaryItemModel1,
                              updateCallback: () => setState(() {}),
                              child: DictionaryItemWidget(
                                item: jsonDecode('''
{
  "name": "",
  "type": "",
  ...
  '''),
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              future: FileGroup.getSysDictionaryListCall.call(
                                page: 1,
                                pageSize: 10,
                              ),
                              builder: (context, snapshot) {
                                ...
                                final columnGetSysDictionaryListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list =
                                        FileGroup.getSysDictionaryListCall
                                                .list(
                                                  columnGetSysDictionaryListResponse
                                                      .jsonBody,
                                                )
                                                ?.toList() ??
                                            [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return DictionaryItemWidget(
                                          key: Key(
                                              'Keysun_${listIndex}_of_${list.length}'),
                                          item: listItem,
                                        );
                                      }),
                                    );
