...
class _ZhengShuBiaoItemWidgetState extends State<ZhengShuBiaoItemWidget> {
  ...
  void initState() {
    ...
    _model.zhengShuMingChengController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.zhengShuMingCheng''',
    ).toString().toString());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.zhengShuMingChengController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText2,
                            enabledBorder: UnderlineInputBorder(
                          ...
                          validator: _model.zhengShuMingChengControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<int>(
                              initialOption: _model.zhengShuLeiBieValue ??=
                                  getJsonField(
                                widget.item,
                                r'''$.zhengShuLeiBie''',
                              ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: _model.shenFenZhengHaoControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            validator: _model.faZhengBuMenControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                  ...
                  children: [
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<int>(
                              initialOption: _model
                                  .zhengShuSuoShuChengShiValue ??= getJsonField(
                                widget.item,
                              ...
                              optionLabels:
                                ...
                                zhengShuSuoShuChengShiFindSysDictionaryResponse
                                    .jsonBody,
                                      ...
                                      .toList(),
                              onChanged: (val) => setState(() =>
                                  _model.zhengShuSuoShuChengShiValue = val),
                              width: 180.0,
                              height: 50.0,
                              textStyle: FlutterFlowTheme.of(context)
                                  .bodyText1
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final zhengShuZhuangTaiFindSysDictionaryResponse =
                                snapshot.data!;
                            return FlutterFlowDropDown<int>(
                              initialOption: _model.zhengShuZhuangTaiValue ??=
                                  getJsonField(
                                widget.item,
                                r'''$.zhengShuZhuangTai''',
                              ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Switch(
                          value: _model.shiFouJieChuValue ??= getJsonField(
                            widget.item,
                            r'''$.shiFouJieChu''',
                          ),
                          onChanged: (newValue) async {
                            setState(() => _model.shiFouJieChuValue = newValue);
                          },
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            controller: _model.zhengShuNianShiYongFeiController,
                            obscureText: false,
                            decoration: InputDecoration(
                              hintStyle: FlutterFlowTheme.of(context).bodyText2,
                              enabledBorder: UnderlineInputBorder(
                                ...
                                return FlutterFlowDropDown<int>(
                                  ...
                                  options: (UserGroup.getUserListCall.userID(
                                    dropDownGetUserListResponse.jsonBody,
                                      ...
                                      .toList(),
                                  optionLabels:
                                      (UserGroup.getUserListCall.userName(
                                    dropDownGetUserListResponse.jsonBody,
                                  ) as List)
                                          .map<String>((s) => s.toString())
                                          .toList()
                                ...
                                itemJson: jsonDecode('''
{
  ...
  "zhengShuMingCheng": "${_model.zhengShuMingChengController.text}",
  ...
  '''),
                        ...
                        InkWell(
                          ...
                          {
  "ID": 1,
  "CreatedAt": "2023-03-02T16:31:32.648+08:00",
  "UpdatedAt": "2023-03-02T16:33:33.694+08:00",
  "group": "所属",
  "zhengShuMingCheng": "证书名称",
  "zhengShuBianHao": "证书编号",
  "zhengShuLeiBie": 1,
  "suoYouRenXingMing": "姓名",
  "shenFenZhengHao": "身份证",
  "shouJiHaoMa": "手机号",
  "faZhengBuMen": "发证部门",
  "zhengShuSuoShuChengShi": 1,
  "zhengShuZhuangTai": 1,
  "zhengShuDaoQiRiQi": "2023-03-02T16:30:53.421+08:00",
  "zhengShuNianShiYongFei": "年费",
  "zhiFuRiQi": "2023-03-02T16:30:53.421+08:00",
  "shiFouJieChu": true,
  "tianJiaRen": 1,
  "beiZhu": "备注"
} */
