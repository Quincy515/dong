...
class DictionaryItemWidget extends StatefulWidget {
  ...
  @override
  _DictionaryItemWidgetState createState() => _DictionaryItemWidgetState();
}
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        context.goNamed(
                          'dictionaryDetail',
                          queryParams: {
                            'sysDictionaryID': serializeParam(
                              getJsonField(
                                widget.item,
                                r'''$.ID''',
                              ),
                    ...
                    InkWell(
                      onLongPress: () async {
                        ...
                        if (confirmDialogResponse) {
                          _model.deleteRes =
                              await FileGroup.deleteSysDictionaryCall.call(
                            id: getJsonField(
                              widget.item,
                              r'''$.ID''',
                            ),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                FileGroup.deleteSysDictionaryCall
                                    .msg(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.updateRes =
                              await FileGroup.updateSysDictionaryCall.call(
                            itemJson: jsonDecode('''
{
  ...
  '''),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                FileGroup.updateSysDictionaryCall
                                    .msg(
