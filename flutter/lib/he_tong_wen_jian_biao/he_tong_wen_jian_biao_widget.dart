...
import '/components/he_tong_wen_jian_item/he_tong_wen_jian_item_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'he_tong_wen_jian_biao_model.dart';
export 'he_tong_wen_jian_biao_model.dart';

class HeTongWenJianBiaoWidget extends StatefulWidget {
  const HeTongWenJianBiaoWidget({Key? key}) : super(key: key);

  @override
  _HeTongWenJianBiaoWidgetState createState() =>
      _HeTongWenJianBiaoWidgetState();
}

class _HeTongWenJianBiaoWidgetState extends State<HeTongWenJianBiaoWidget> {
  late HeTongWenJianBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HeTongWenJianBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.heTongWenJianItemModel1,
                              updateCallback: () => setState(() {}),
                              child: HeTongWenJianItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "faPiaoLeiXing": 1,
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetHeTongWenJianBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = HeTongWenJianBiaoGroup
                                            .getHeTongWenJianBiaoListCall
                                            .list(
                                              columnGetHeTongWenJianBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
