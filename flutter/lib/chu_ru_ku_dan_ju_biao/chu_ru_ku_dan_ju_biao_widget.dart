...
import 'chu_ru_ku_dan_ju_biao_model.dart';
export 'chu_ru_ku_dan_ju_biao_model.dart';

class ChuRuKuDanJuBiaoWidget extends StatefulWidget {
  const ChuRuKuDanJuBiaoWidget({Key? key}) : super(key: key);

  @override
  _ChuRuKuDanJuBiaoWidgetState createState() => _ChuRuKuDanJuBiaoWidgetState();
}

class _ChuRuKuDanJuBiaoWidgetState extends State<ChuRuKuDanJuBiaoWidget> {
  late ChuRuKuDanJuBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChuRuKuDanJuBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.chuRuKuDanJItemModel1,
                              updateCallback: () => setState(() {}),
                              child: ChuRuKuDanJItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "caiGouJiHuaId": 0,
  "chuRuKuDanJuLeiXing": 1,
  "group": "",
  "tianJiaRen": 0,
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetChuRuKuDanJuBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = ChuRuKuDanJuBiaoGroup
                                            .getChuRuKuDanJuBiaoListCall
                                            .list(
                                              columnGetChuRuKuDanJuBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return wrapWithModel(
                                          model: _model.chuRuKuDanJItemModels2
                                              .getModel(
                                            listIndex.toString(),
                                            listIndex,
                                          ),
