...
import 'xiang_mu_biao_model.dart';
export 'xiang_mu_biao_model.dart';

class XiangMuBiaoWidget extends StatefulWidget {
  const XiangMuBiaoWidget({Key? key}) : super(key: key);

  @override
  _XiangMuBiaoWidgetState createState() => _XiangMuBiaoWidgetState();
}

class _XiangMuBiaoWidgetState extends State<XiangMuBiaoWidget> {
  late XiangMuBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => XiangMuBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.xiangMuBiaoItemModel1,
                              updateCallback: () => setState(() {}),
                              child: XiangMuBiaoItemWidget(
                                item: jsonDecode('''
{
  "jiHuaKaiGongRiQi": "${DateTime.now()}",
  "jiHuaJieShuRiQi": "${DateTime.now()}",
  "shiJiKaiGongRiQi": "${DateTime.now()}",
  "shiJiJieShuRiQi": "${DateTime.now()}",
  "baoZhangJinZhuangTai": 1,
  "baoZhengJinZhuangTai": 1,
  "fuKuanFangShi": 1,
  "jieSuanZhuangTai": 1,
  "xiangMuZhuangTai": 2,
  "xiangMuJingLi": 1,
  ...
  '''),
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              future:
                                  XiangMuBiaoGroup.getXiangMuBiaoListCall.call(
                                page: 1,
                                pageSize: 10,
                              ),
                              builder: (context, snapshot) {
                                ...
                                final columnGetXiangMuBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list =
                                        XiangMuBiaoGroup.getXiangMuBiaoListCall
                                                .list(
                                                  columnGetXiangMuBiaoListResponse
                                                      .jsonBody,
                                                )
                                                ?.toList() ??
                                            [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return XiangMuBiaoItemWidget(
                                          key: Key(
                                              'Keyija_${listIndex}_of_${list.length}'),
                                          item: listItem,
                                        );
                                      }),
                                    );
