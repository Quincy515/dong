...
import 'cai_gou_ji_hua_biao_model.dart';
export 'cai_gou_ji_hua_biao_model.dart';

class CaiGouJiHuaBiaoWidget extends StatefulWidget {
  const CaiGouJiHuaBiaoWidget({Key? key}) : super(key: key);

  @override
  _CaiGouJiHuaBiaoWidgetState createState() => _CaiGouJiHuaBiaoWidgetState();
}

class _CaiGouJiHuaBiaoWidgetState extends State<CaiGouJiHuaBiaoWidget> {
  late CaiGouJiHuaBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CaiGouJiHuaBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue!)
                            wrapWithModel(
                              model: _model.caiGouJiHuaItemModel1,
                              updateCallback: () => setState(() {}),
                              child: CaiGouJiHuaItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "caiGouFuZeRen": 0,
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetCaiGouJiHuaBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = CaiGouJiHuaBiaoGroup
                                            .getCaiGouJiHuaBiaoListCall
                                            .list(
                                              columnGetCaiGouJiHuaBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return wrapWithModel(
                                          model: _model.caiGouJiHuaItemModels2
                                              .getModel(
                                            listIndex.toString(),
                                            listIndex,
                                          ),
