...
import 'kao_qin_tong_ji_item_model.dart';
export 'kao_qin_tong_ji_item_model.dart';

class KaoQinTongJiItemWidget extends StatefulWidget {
  const KaoQinTongJiItemWidget({
    Key? key,
    this.item,
  }) : super(key: key);
  ...
  @override
  _KaoQinTongJiItemWidgetState createState() => _KaoQinTongJiItemWidgetState();
}

class _KaoQinTongJiItemWidgetState extends State<KaoQinTongJiItemWidget> {
  late KaoQinTongJiItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => KaoQinTongJiItemModel());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.chuQinTianShuController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText2,
                            enabledBorder: UnderlineInputBorder(
                          ...
                          validator: _model.chuQinTianShuControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            controller: _model.qingJiaTianShuController,
                            obscureText: false,
                            decoration: InputDecoration(
                              hintStyle: FlutterFlowTheme.of(context).bodyText2,
                              enabledBorder: UnderlineInputBorder(
                            ...
                            validator: _model.qingJiaTianShuControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                    ...
                    InkWell(
                      onLongPress: () async {
                        ...
                        if (confirmDialogResponse) {
                          _model.deleteRes =
                              await BanGongShiGroup.deleteKaoQinTongJiCall.call(
                            id: getJsonField(
                              widget.item,
                              r'''$.ID''',
                            ),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                BanGongShiGroup.deleteKaoQinTongJiCall
                                    .msg(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                BanGongShiGroup.updateKaoQinTongJiCall
                                    .msg(
