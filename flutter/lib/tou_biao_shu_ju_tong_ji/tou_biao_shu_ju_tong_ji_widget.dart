...
class TouBiaoShuJuTongJiWidget extends StatefulWidget {
  const TouBiaoShuJuTongJiWidget({Key? key}) : super(key: key);

  @override
  _TouBiaoShuJuTongJiWidgetState createState() =>
      _TouBiaoShuJuTongJiWidgetState();
}

class _TouBiaoShuJuTongJiWidgetState extends State<TouBiaoShuJuTongJiWidget> {
  late TouBiaoShuJuTongJiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TouBiaoShuJuTongJiModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    _model.getRes = await JingYingBuGroup
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.touBiaoShuJuTongJiItemModel1,
                              updateCallback: () => setState(() {}),
                              child: TouBiaoShuJuTongJiItemWidget(
                                item: _model,
                              ),
                            ),
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetTouBiaoShuJuTongJiListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = JingYingBuGroup
                                            .getTouBiaoShuJuTongJiListCall
                                            .list(
                                              columnGetTouBiaoShuJuTongJiListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return SingleChildScrollView(
                                      ...
                                      child: Column(
                                        ...
                                        children: List.generate(list.length,
                                          ...
                                          return TouBiaoShuJuTongJiItemWidget(
                                            key: Key(
                                                'Keyus4_${listIndex}_of_${list.length}'),
                                            item: listItem,
                                          );
                                        }),
                                      ),
