...
import 'fen_bao_shang_biao_model.dart';
export 'fen_bao_shang_biao_model.dart';

class FenBaoShangBiaoWidget extends StatefulWidget {
  const FenBaoShangBiaoWidget({Key? key}) : super(key: key);

  @override
  _FenBaoShangBiaoWidgetState createState() => _FenBaoShangBiaoWidgetState();
}

class _FenBaoShangBiaoWidgetState extends State<FenBaoShangBiaoWidget> {
  late FenBaoShangBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FenBaoShangBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.fenBaoShangItemModel1,
                              updateCallback: () => setState(() {}),
                              child: FenBaoShangItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "faRen": "",
  "faRenShouJi": "",
  "fenBaoShangLeiXing": 1,
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetFenBaoShangBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = FenBaoShangBiaoGroup
                                            .getFenBaoShangBiaoListCall
                                            .list(
                                              columnGetFenBaoShangBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return wrapWithModel(
                                          model: _model.fenBaoShangItemModels2
                                              .getModel(
                                            listIndex.toString(),
                                            listIndex,
                                          ),
