...
import 'shi_gong_jin_du_biao_model.dart';
export 'shi_gong_jin_du_biao_model.dart';

class ShiGongJinDuBiaoWidget extends StatefulWidget {
  const ShiGongJinDuBiaoWidget({Key? key}) : super(key: key);

  @override
  _ShiGongJinDuBiaoWidgetState createState() => _ShiGongJinDuBiaoWidgetState();
}

class _ShiGongJinDuBiaoWidgetState extends State<ShiGongJinDuBiaoWidget> {
  late ShiGongJinDuBiaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShiGongJinDuBiaoModel());
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.switchValue ?? true)
                            wrapWithModel(
                              model: _model.shiGongJinDuItemModel1,
                              updateCallback: () => setState(() {}),
                              child: ShiGongJinDuItemWidget(
                                item: jsonDecode('''
{
  "beiZhu": "",
  "gongZuoMingChengId": 0,
  "group": "",
  "shiJiKaiShiRiQi": "${DateTime.now()}",
  "shiJiTianShu": 0,
  "shiJiWanChengRiQi": "${DateTime.now()}",
  "tianJiaRen": 0,
                          ...
                          if (!_model.switchValue!)
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnGetShiGongJinDuBiaoListResponse =
                                    snapshot.data!;
                                return Builder(
                                  builder: (context) {
                                    final list = ShiGongJinDuBiaoGroup
                                            .getShiGongJinDuBiaoListCall
                                            .list(
                                              columnGetShiGongJinDuBiaoListResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                    return Column(
                                      ...
                                      children: List.generate(list.length,
                                        ...
                                        return wrapWithModel(
                                          model: _model.shiGongJinDuItemModels2
                                              .getModel(
                                            listIndex.toString(),
                                            listIndex,
                                          ),
