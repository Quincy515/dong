...
class FlutterFlowDropDownNew<T> extends StatefulWidget {
  const FlutterFlowDropDownNew({
  ...
  @override
  State<FlutterFlowDropDownNew<T>> createState() =>
      _FlutterFlowDropDownState<T>();
}

class _FlutterFlowDropDownState<T> extends State<FlutterFlowDropDownNew<T>> {
