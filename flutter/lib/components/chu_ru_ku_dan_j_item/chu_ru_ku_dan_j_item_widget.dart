...
import 'chu_ru_ku_dan_j_item_model.dart';
export 'chu_ru_ku_dan_j_item_model.dart';

class ChuRuKuDanJItemWidget extends StatefulWidget {
  const ChuRuKuDanJItemWidget({
    Key? key,
    this.item,
  }) : super(key: key);
  ...
  @override
  _ChuRuKuDanJItemWidgetState createState() => _ChuRuKuDanJItemWidgetState();
}

class _ChuRuKuDanJItemWidgetState extends State<ChuRuKuDanJItemWidget> {
  late ChuRuKuDanJItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChuRuKuDanJItemModel());
    ...
    _model.xiangMuIdxiangMuIdController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.xiangMuId''',
    ).toString().toString());
    _model.caiGouJiHuaIdController ??= TextEditingController(
        text: getJsonField(
      widget.item,
      r'''$.caiGouJiHuaId''',
    ).toString().toString());
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.xiangMuIdxiangMuIdController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText1,
                            enabledBorder: UnderlineInputBorder(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          controller: _model.caiGouJiHuaIdController,
                          obscureText: false,
                          decoration: InputDecoration(
                            hintStyle: FlutterFlowTheme.of(context).bodyText1,
                            enabledBorder: UnderlineInputBorder(
                          ...
                          keyboardType: TextInputType.number,
                          validator: _model.caiGouJiHuaIdControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ),
                      ...
                      child: Container(
                        ...
                        child: FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final chuRuKuDanJuLeiXingFindSysDictionaryResponse =
                                snapshot.data!;
                            return FlutterFlowDropDownNew<int>(
                              controller:
                                  _model.chuRuKuDanJuLeiXingController ??=
                                      FormFieldController<int>(
                                _model.chuRuKuDanJuLeiXingValue ??=
                                    getJsonField(
                                  widget.item,
                                  r'''$.chuRuKuDanJuLeiXing''',
                                ),
                              ),
                              options: (FileGroup.findSysDictionaryCall.value(
                                chuRuKuDanJuLeiXingFindSysDictionaryResponse
                                    .jsonBody,
                              ) as List)
                              ...
                              onChanged: (val) => setState(
                                  () => _model.chuRuKuDanJuLeiXingValue = val),
                              width: 220.0,
                              height: 50.0,
                    ...
                    InkWell(
                      onLongPress: () async {
                        ...
                        if (confirmDialogResponse) {
                          _model.deleteRes = await ChuRuKuDanJuBiaoGroup
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                ChuRuKuDanJuBiaoGroup.deleteChuRuKuDanJuBiaoCall
                                    .msg(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.updateRes = await ChuRuKuDanJuBiaoGroup
                            ...
                            itemJson: jsonDecode('''
{
  ...
  "caiGouJiHuaId": ${_model.caiGouJiHuaIdController.text},
  "chuRuKuDanJuLeiXing": ${_model.chuRuKuDanJuLeiXingValue},
  "group": "${_model.groupController.text}",
  "tianJiaRen": ${_model.tianJiaRenValue},
  "tianJiaRiQi": "${dateTimeRfc3339(dateTime: _model.datePicked)}",
  "xiangMuId": ${_model.xiangMuIdxiangMuIdController.text},
  ...
  '''),
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                ChuRuKuDanJuBiaoGroup.updateChuRuKuDanJuBiaoCall
                                    .msg(
